...
Route::group(['prefix' => 'admin'], function(){
    ...
    **/
    ...
    Route::get('/profile/{id}/linkNewPermission',[ProfilePermissionController::class,'linkNewPermission'])->name('profiles.linkNewPermission');
    Route::get('/permissions/{id}/linkNewProfile',[ProfilePermissionController::class,'linkNewProfile'])->name('permissions.linkNewProfile');

    Route::any('/profile/{id}/linkNewPermission/store',[ProfilePermissionController::class,'linkNewPermissionStore'])->name('profiles.linkNewPermissionStore');
