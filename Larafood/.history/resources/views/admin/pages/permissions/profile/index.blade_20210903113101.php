...
@section('content_header')
    <h1>Vincular novo perfil à Permissão {{$permission->name}} <a href="{{route('permissions.linkNewProfile',$permission->id)}}" class="btn btn-dark"><i class="fa fa-plus-circle"></i></a> </h1>
@stop
            ...
            <table class="table table-condensed">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td style="width=10px">
                            <a href="{{route('permissions.edit',$permission->id)}}" class="btn btn-danger">Desvincular</a>
                        </td>
                    </tr>
                    @empty
                    <tr >
