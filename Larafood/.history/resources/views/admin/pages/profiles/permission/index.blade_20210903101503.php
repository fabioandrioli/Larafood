...
@section('content_header')
    <h1>Vincular nova Permissão no Perfil: {{$profile->name}} <a href="{{route('profile.linkNewPermission',$profile->id)}}" class="btn btn-dark"><i class="fa fa-plus-circle"></i></a> </h1>
@stop
