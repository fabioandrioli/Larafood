...
@section('content')
    <div class="card">
        ...
        <div class="card-header">
            <form class="form form-inline" method="POST" action="{{route('profiles.linkNewPermissionStore',$profile->id)}}">
                @csrf
        ...
        <div class="card-body">
            ...
            <table class="table table-condensed">
                ...
                <tbody>
                    <form action="{{route('profiles.linkNewPermissionStore',$profile->id)}}" method="POST">
                        @csrf
