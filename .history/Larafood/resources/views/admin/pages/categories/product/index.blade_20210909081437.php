...
@section('content_header')
    <h1>Vincular novo Produto na Categoria: {{$category->name}} <a href="{{route('categories.linkNewPlan',$category->id)}}" class="btn btn-dark"><i class="fa fa-plus-circle"></i></a> </h1>
@stop
            ...
            <table class="table table-condensed">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td style="width=10px">
                            <a href="{{route('categories.plans.unbindPlan',[$category->id,$plan->id])}}" class="btn btn-danger">Desvincular</a>
                        </td>
                    </tr>
                    @empty
                    <tr >
