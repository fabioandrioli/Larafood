            ...
            <table class="table table-condensed">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td style="width=10px">
                            <a href="{{route('products.edit',$product->url)}}" class="btn btn-info">Editar</a>
                            <a href="{{route('products.show',$product->url)}}" class="btn btn-warning">Ver</a>
                        </td>
                    </tr>
                    @empty
                    <tr >
                        <td> <p>Nenhum producto encontrado.</p></td>
                    </tr>
                    @endforelse
                </tbody>
            </table>
