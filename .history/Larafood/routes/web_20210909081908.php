...
Route::group(['prefix' => 'admin','middleware' => 'auth'], function(){
    ...
    **/
    ...
    Route::get('/categories/{id}/permissions',[CategoryController::class,'categories'])->name('categories.permissions');

    Route::any('/profile/{id}/linkNewPermission',[CategoryController::class,'linkNewPermission'])->name('categories.linkNewPermission');
  
    Route::post('/profile/{id}/linkNewPermission/store',[CategoryController::class,'linkNewPermissionStore'])->name('categories.linkNewPermissionStore');

    Route::get('/categories/{id}/permissions/{idPermission}/unbindPermission',[CategoryController::class,'unbindPermission'])->name('categories.permissions.unbindPermission');
