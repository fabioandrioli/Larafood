...
Route::group(['prefix' => 'admin','middleware' => 'auth'], function(){
    ...
    **/
    ...
    Route::get('users/{id}/products',[UserRoleController::class,'users'])->name('users.products');

    Route::any('category/{id}/linkNewRole',[UserRoleController::class,'linkNewRole'])->name('users.linkNewRole');
  
    Route::post('category/{id}/linkNewRole/store',[UserRoleController::class,'linkNewRoleStore'])->name('users.linkNewRoleStore');

    Route::get('users/{id}/products/{idRole}/unbindRole',[UserRoleController::class,'unbindRole'])->name('users.products.unbindRole');
