...
Route::group(['prefix' => 'admin','middleware' => 'auth'], function(){
    ...
    **/
    ...
    Route::get('/categories/{id}/products',[CategoryController::class,'categories'])->name('categories.products');

    Route::any('/category/{id}/linkNewProduct',[CategoryController::class,'linkNewProduct'])->name('categories.linkNewProduct');
  
    Route::post('/category/{id}/linkNewProduct/store',[CategoryController::class,'linkNewProductStore'])->name('categories.linkNewProductStore');

    Route::get('/categories/{id}/products/{idProduct}/unbindProduct',[CategoryController::class,'unbindProduct'])->name('categories.products.unbindproduct');
