...
Route::group(['prefix' => 'admin','middleware' => 'auth'], function(){
    ...
    **/
    Route::get('roles/{id}/permissions',[ProfilePermissionController::class,'roles'])->name('roles.permissions');

    Route::get('permissions/{id}/roles',[ProfilePermissionController::class,'permissions'])->name('permissions.roles');

    Route::any('role/{id}/linkNewPermission',[ProfilePermissionController::class,'linkNewPermission'])->name('roles.linkNewPermission');
  
    Route::post('role/{id}/linkNewPermission/store',[ProfilePermissionController::class,'linkNewPermissionStore'])->name('roles.linkNewPermissionStore');

    Route::get('roles/{id}/permissions/{idPermission}/unbindPermission',[ProfilePermissionController::class,'unbindPermission'])->name('roles.permissions.unbindPermission');
