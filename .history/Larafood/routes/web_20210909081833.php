...
Route::group(['prefix' => 'admin','middleware' => 'auth'], function(){
    ...
    **/
    ...
    Route::get('/profiles/{id}/permissions',[CategoryController::class,'profiles'])->name('profiles.permissions');

    Route::any('/profile/{id}/linkNewPermission',[CategoryController::class,'linkNewPermission'])->name('profiles.linkNewPermission');
  
    Route::post('/profile/{id}/linkNewPermission/store',[CategoryController::class,'linkNewPermissionStore'])->name('profiles.linkNewPermissionStore');

    Route::get('/profiles/{id}/permissions/{idPermission}/unbindPermission',[CategoryController::class,'unbindPermission'])->name('profiles.permissions.unbindPermission');
